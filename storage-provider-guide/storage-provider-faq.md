...
docker run --name es  -d  \
          ...
          ghcr.io/ethstorage/es-node:v0.2.10 \
...
3. Install new version (e.g., `es-node.v0.2.10`) of the pre-built package.
```sh
VERSION=v0.2.10
...
2. Switch to the correct branch of the source code (e.g., you want to move to `v0.2.10`):
...
# replace 'v0.2.10' to your target version
